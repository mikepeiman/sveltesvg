<script>
  ...
  export function getOrigin(e) {
    ...
    penta.attribute("fill", `hsl(${hueX},100%,50%)`)
    console.log(`!!!!!!!!!!!!!!!!!!!!!!!!!!!!! svg parent width ${elX} ${hueFactorX}, ${elY} ${hueFactorY}`)
...
<div class="svg-card" id="svg-container" on:click={getOrigin}>
